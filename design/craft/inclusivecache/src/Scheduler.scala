...
class InclusiveCacheBankScheduler(params: InclusiveCacheParameters, nRCID: Int, nDramBanks: Int, dramBankOffset: Int) extends Module
{
  ...
  val sourceA = Module(new SourceA(params, nRCID, nDramBanks, dramBankOffset))
