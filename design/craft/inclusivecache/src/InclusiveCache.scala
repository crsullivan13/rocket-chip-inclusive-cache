    ...
    extends LazyModule
{
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    regnode.regmap(
      ...
      0x050 -> Seq(perfEnField),
      0x060 -> RegFieldGroup("LineRefill", Some("Per-domain line refill count"), lineRefillRegField),
      0x080 -> RegFieldGroup("WriteBack", Some("Per-domain writeback count"), writeBackRegField),
      0x100 -> RegFieldGroup("SinkAStall", Some("Per-domain sinkA stall cycle count"), sinkAStallRegField),
    )
